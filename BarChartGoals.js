...
let colors = [
    'rgba(255, 0, 0, 1)',      // Bombers (Red/Black)
    ...
    'rgba(0, 0, 128, 1)',      // Crows (Blue/Red/Yellow)
    'rgba(128, 64, 0, 1)',     // Hawks (Brown/Gold)
    'rgba(0, 51, 204, 1)',     // Blues (Navy Blue/White)
    'rgba(255, 0, 0, 1)',      // Swans (Red/White)
    'rgba(0, 102, 204, 1)',    // Kangaroos (Blue/White)
    'rgba(0, 51, 102, 1)',     // Cats (Navy Blue/White)
    'rgba(255, 0, 0, 1)',      // Suns (Red/Yellow)
    'rgba(0, 0, 102, 1)',      // Demons (Navy Blue/Red)
    'rgba(0, 128, 128, 1)',    // Power (Teal/Black/White)
    'rgba(0, 0, 0, 1)',        // Magpies (Black/White)
    'rgba(255, 204, 0, 1)',    // Tigers (Yellow/Black)
    'rgba(0, 51, 153, 1)'      // Eagles (Blue/Gold)
];
